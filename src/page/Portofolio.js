    ...
    return (
      <div>
        ...
        <div className="col-md-12" style={{ marginBottom: 20 }} key='6'>
            ...
            <p>URL: <a href="https://github.com/denihida1216/">Google Play</a></p>
            <LazyLoadImage
              alt="profil"
              width="100%"
              effect="blur"
            ...
            <p>
            <br />
              Dibangun menggunakan python 3 dengan bantuan software build Pycharm.
            </p>
          </div>
          ...
          <div className="col-md-12" style={{ marginBottom: 20 }} key='1'>
            ...
            sehingga dapat terpantau pekerjaan yang diberikan antar departmen yang melakukan work order dan pengingat
              pada setiap pekerjaan yang diberikan sekaligus dengan rekap data work order setiap akhir bulan antar departmen.
              <br />
